      ...
      skills: [
        {
          ...
          child: [
            ...
            {name: 'jQuery', background: 'rgba(29, 218, 61, 0.2)'},
            {name: 'HTML', background: 'rgba(29, 218, 61, 0.2)'}
          ]
        },
        {
          name: '服务端',
        ...
        },
        {
          ...
          child: [
            ...
            {name: 'stylus', background: 'rgba(232, 13, 24, 0.2)'},
            {name: 'swiper', background: 'rgba(232, 13, 24, 0.2)'}
          ]
        }
      ]
    }
